      ...
      <section className="relative py-10 md:py-14 bg-muted/30">
        ...
        <div className="container-wide relative z-10 text-center">
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto mb-4">
            Cleanse–protect–moisturize bundles for nursing homes, assisted living and home-care buyers — one kit covers the full incontinence skin care routine.
          </p>
      ...
      <section className="bg-muted/20 py-16">
        <div className="container-wide text-center max-w-2xl mx-auto">
          <h2 className="font-serif text-2xl md:text-3xl font-bold mb-4">
            Complete Incontinence Skin Care Kits
          </h2>
          <p className="text-muted-foreground mb-8">
            Ideal for facility trials and distributor sampling — one kit covers cleansing, barrier protection and moisturizing without the selection friction of buying single items.
          </p>
