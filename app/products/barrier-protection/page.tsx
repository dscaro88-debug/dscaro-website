      ...
      <section className="relative py-10 md:py-14 bg-muted/30">
        ...
        <div className="container-wide relative z-10 text-center">
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto mb-4">
            Zinc oxide and dimethicone barrier creams plus a no-sting, alcohol-free film-forming skin protectant spray — protecting intact or compromised skin from moisture, friction and IAD.
          </p>
      ...
      <section className="bg-muted/20 py-16">
        <div className="container-wide text-center max-w-2xl mx-auto">
          <h2 className="font-serif text-2xl md:text-3xl font-bold mb-4">
            Bulk Barrier Protection for Care Facilities
          </h2>
          <p className="text-muted-foreground mb-8">
            We supply nursing homes, assisted living communities and incontinence care distributors with barrier creams and CHG-compatible skin protectant spray for daily IAD prevention.
          </p>
