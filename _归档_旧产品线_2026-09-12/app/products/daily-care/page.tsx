...
export const metadata: Metadata = {
  title: "Daily Care for Incontinence Care — Bed Pads, Protectors, Towels | DS CARO",
  description:
    "B2B wholesale Daily Care: barrier protection products, washable bed pads, waterproof mattress protectors, care towels, and hygiene supplies for nursing homes and assisted living. OEM/ODM available.",
  openGraph: {
    title: "Daily Care for Nursing Homes | DS CARO",
    description:
      "Washable bed pads, waterproof protectors, and Daily Care for Incontinence Care facilities. OEM/ODM with flexible order quantities.",
  },
}

export const dynamic = "force-dynamic"

const products = allProducts.filter((product) => product.category === "Daily Care")
      ...
      <section className="relative py-10 md:py-14 bg-muted/30">
        ...
        <div className="container-wide relative z-10 text-center">
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto mb-4">
            Bedding protection and daily hygiene supplies for Incontinence Care facilities — supporting care routines with practical, durable products.
          </p>
      ...
      <section className="bg-muted/20 py-16">
        <div className="container-wide text-center max-w-2xl mx-auto">
          ...
          <p className="text-muted-foreground mb-8">
            We supply nursing home chains, assisted living communities, and care distributors with Daily Care for hygiene, incontinence, and bedding protection.
          </p>
