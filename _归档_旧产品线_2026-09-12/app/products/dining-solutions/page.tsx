...
export const metadata: Metadata = {
  title: "cleansing solutions for Incontinence Care — cleansing foams, Clothing Protectors | DS CARO",
  description:
    "B2B wholesale dining care products: reusable cleansing foams, waterproof clothing protectors, crumb catcher bibs, and wheelchair dining aprons for nursing homes and assisted living. OEM/ODM available.",
  openGraph: {
    title: "cleansing solutions for Nursing Homes & Incontinence Care | DS CARO",
    description:
      "cleansing foams, clothing protectors, and dining aprons for skilled nursing facilities and assisted living. OEM/ODM with flexible MOQ.",
  },
}
                  ...
                  <Card key={entry.id} className="overflow-hidden border-0 shadow-sm">
                    ...
                    <div className="p-5">
                      ...
                      <p className="text-muted-foreground mb-6">
                        Reserved SKU in the cleansing solutions category. Real product content will be published when the Excel info card is finalized with the supplier.
                      </p>
      ...
      <section className="bg-muted/20 py-16">
        <div className="container-wide text-center max-w-2xl mx-auto">
          <h2 className="font-serif text-2xl md:text-3xl font-bold mb-4">
            Need Custom cleansing solutions?
          </h2>
