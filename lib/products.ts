...
const productSeeds: ProductSeed[] = [
  ...
  {
    id: "DS-DIN-002",
    name: "Premium Jewelry-Decorated Waterproof Adult Bib",
    category: "Dining Solutions",
    subcategory: "Adult Bibs",
    description:
      "Dignity-focused waterproof adult bib with fashionable jewelry-style decoration (pearl, crystal, embroidery patterns). Built-in crumb catcher pocket, machine-washable 100+ cycles, ideal for premium care homes and gift channels.",
    moq: 100,
    price: 0,
    currency: "USD",
    priceLabel: "Request Quote",
    priceNote:
      "FOB pricing depends on pattern, fabric, and order quantity. Submit an RFQ for current quote.",
    ...
    material: "PU waterproof front, soft polyester back, hook & loop closure",
    targetBuyers: "Premium care home procurement, assisted living supply chains, fashion-forward senior distributors, gift channel buyers",
    marketPosition: "Dignity-preserving decorative bib — premium pattern options for facilities that want resident care without the institutional look",
    featured: true,
    features: [
      "Waterproof PU front prevents soak-through and staining",
      "Built-in crumb catcher pocket reduces floor cleanup",
      "Machine washable, rated 100+ industrial laundry cycles",
      "Hook & loop adjustable closure — easy on/off for care staff",
      "14+ decorative patterns including pearl, crystal, embroidery styles",
      "Dignity-focused design — looks like a fashion accessory, not medical equipment",
      "OEM label, custom packaging, and pattern selection available for private label"
    ],
    specs: {
      "Fabric": "PU waterproof front, polyester back",
      "Closure": "Hook & loop (velcro) adjustable",
      "Wash Rating": "100+ industrial cycles",
      "Crumb Catcher": "Built-in crumb catcher pocket",
      "Sizes": "75cm x 45cm (30\" x 18\") — Adult standard",
      "Pattern Options": "14+ decorative patterns (jewelry & embroidery)",
      "Use Scenario": "Premium nursing home dining, assisted living, senior gift channels, dignity-focused care environments"
    },
  },
  {
    id: "DS-DIN-003",
    ...
    subcategory: "Adult Bibs",
    description:
      "Dignity-positive dementia-care adult bib with humorous 'IF YOU CAN read this I haven't eaten yet' print. Designed to help memory-care residents self-communicate meal needs and reduce staff guesswork. Waterproof, machine-washable.",
    moq: 100,
    price: 0,
    currency: "USD",
    priceLabel: "Request Quote",
    priceNote:
      "FOB pricing depends on pattern customization and order quantity. Submit an RFQ for current quote.",
    ...
    material: "PU waterproof front, soft polyester back, hook & loop closure, humorous message print",
    targetBuyers: "Memory care units, dementia-specialist facilities, Alzheimer's day centers, gerontology researchers, care home procurement for special-needs residents",
    marketPosition: "Therapeutic communication tool for memory care — dignity-positive alternative to standard institutional bibs",
    featured: true,
    features: [
      ...
      "Built-in crumb catcher pocket reduces floor cleanup",
      "Machine washable, rated 100+ industrial laundry cycles",
      "Soft hook & loop closure — easy on/off for care staff",
      "Positive engagement design — turns a care product into a conversation starter",
      "Ideal for memory care, dementia wards, and Alzheimer's support facilities",
      "OEM label, custom message, and packaging available for facility-specific deployments"
    ],
    specs: {
      "Fabric": "PU waterproof front, polyester back",
      "Closure": "Hook & loop (velcro) adjustable",
      ...
      "Crumb Catcher": "Built-in crumb catcher pocket",
      "Sizes": "75cm x 45cm (30\" x 18\") — Adult standard",
      "Use Scenario": "Memory care, dementia units, Alzheimer's day centers, special-needs care facilities"
    },
  },
  {
    id: "DS-DIN-004",
